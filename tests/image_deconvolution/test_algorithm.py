...
def test_RicharsonLucy(dataset, model, mask, tmp_path):
    ...
    assert np.isclose(algorithm.results[-1]['log-likelihood'][0], 5259.242894137228)
    ...
    assert np.isclose(algorithm.results[-1]['log-likelihood'][0], 5226.135408675148) 
...
def test_MAP_RichardsonLucy(dataset, model, mask, tmp_path):
    ...
    assert np.isclose(algorithm.results[-1]['log-posterior'], 5298.642098311226)
    ...
    assert np.isclose(algorithm.results[-1]['log-posterior'], 4951.657349512739)
    ...
    assert np.isclose(algorithm.results[-1]['log-likelihood'][0], 4850.641606406938)
    ...
    assert np.isclose(algorithm.results[-1]['log-posterior'], 4850.604374561122)
