...
class BinnedData(UnBinnedData):
    ...
    def get_binned_data(self, unbinned_data=None, output_name=None,
        ...
        sparse : bool, optional
            'True' for sparse binning,
            'False' for dense binning (default is False)
        track_overflow : bool, optional
             option to track over/underflow bin (default is False)
    ...
    def get_binning_info(self, binned_data=None):
        ...
        self.time_hist = self.binned_data.project('Time').todense().contents
        ...
        self.energy_hist = self.binned_data.project('Em').todense().contents
        ...
        self.phi_hist = self.binned_data.project('Phi').todense().contents
        ...
        self.psichi_hist = self.binned_data.project('PsiChi').todense().contents
