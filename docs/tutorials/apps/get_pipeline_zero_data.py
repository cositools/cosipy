...
fetch_wasabi_file('COSI-SMEX/develop/Data/Orientation/'+filename,
                  output=indir/filename,
...
fetch_wasabi_file('COSI-SMEX/DC3/Data/Backgrounds/Ge/'+filename,
                  output=indir/filename,
                  checksum = '9fda5a7b15a90358abc2b886979f9fef', unzip=True)
...
fetch_wasabi_file('COSI-SMEX/DC3/Data/Sources/'+filename,
                  output=indir/filename,
                  checksum = '570a0ef083044123a811fb95d803098a', unzip=True)
#
#
#==================================
#
